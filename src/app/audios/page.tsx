    ...
    <div>
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-blue-100 to-purple-200 p-4">
        <h1 className="text-3xl font-bold mb-4 text-purple-700">
          Audio resources for mental health wellness
        </h1>
        ...
        <p className="flex py-6">
          If you&apos;re looking to store audio clips on cloud platforms and
          want to use a free plan here are a few popular ones that offer free
          tiers:
        </p>
        <ul>
          <li>
            ...
            <ul>
              ...
              <li>
                If you exceed the free storage limit. you&apos;ll need to pay
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                Ideal if you&apos;re in the Apple ecosystem and need to store
                your audio files for access across devices.
              </li>
            </ul>
          </li>
          <li>
